...
for i in range(nProj, nProj + nDummy):
...
# %%
if FLAG_PLOT:
  seq.plot(grad_disp="mT/m",show_blocks=True,time_range=(TR,TR*3),time_disp="s",label="SET,PAR")
...
if FLAG_WRITE_SEQ:
  ...
  seq_filename = "gradient_arb_ute_100l_ADC_pypulseq.seq"
