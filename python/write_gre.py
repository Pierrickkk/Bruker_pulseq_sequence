...
def main(plot: bool = False, write_seq: bool = False, seq_filename: str = 'gre_1l_pypulseq.seq'):
    # ======
    # SETUP
    # ======
    ...
    if write_seq:
        ...
        seq.write("/workspace_QMRI/PROJECTS_DATA/2026_RECH_bruker_pulseq/pypulseq" +"/"+ seq_filename)
