...
def main(plot: bool = False, write_seq: bool = False, seq_filename: str = 'gradient_trap_alone_pypulseq.seq'):
    # ======
    # SETUP
    # ======
    ...
    delay_TR = (
        np.ceil(
            (TR - pp.calc_duration(gx) - delay_TE)
            / seq.grad_raster_time
        )
        * seq.grad_raster_time
    )
