...
def main(plot: bool = False, write_seq: bool = False, seq_filename: str = 'Trig_gre_2l_physio2_pypulseq.seq'):
    # ======
    # SETUP
    # ======
    ...
    if write_seq:
        ...
        seq.write("/workspace_QMRI/PROJECTS_DATA/2026_RECH_bruker_pulseq/pypulseq/output" +"/"+ seq_filename)
