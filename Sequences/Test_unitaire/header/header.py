...
output_path = "/workspace_QMRI/PROJECTS_DATA/2026_RECH_bruker_pulseq/pypulseq/python/Test_unitaire/header/output"
filename = "GRE_no_headerseq"
...
seq.set_definition(key='adc_dead_time', value=system.adc_dead_time)

seq.set_definition(key='Name', value='GRE_no_header')
