...
for s in range(n_slices):
    ...
    seq.add_block(pp.make_label(type='SET', label='TRID', value=0))
    ...
    for i in range(Ny):
        ...
        rf_inc = divmod(rf_inc + rf_spoiling_inc, 360.0)[1]
        rf_phase = divmod(rf_phase + rf_inc, 360.0)[1]
        seq.add_block(pp.make_label(type='SET', label='TRID', value=2))
        seq.add_block(rf, gz)
...
output_path = "/workspace_QMRI/PROJECTS_DATA/2026_RECH_bruker_pulseq/pypulseq/python/Test_unitaire/TRID/output"
filename = "trid_gre"
